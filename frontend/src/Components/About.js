    ...
    <div>
      ...
      {showOption2 && (
        <div id="option2">
          ...
          <p>Whether you're an avid reader or a casual learner, "My Library" has something for everyone. Our collection covers a wide range of genres and topics, from classic literature to the latest bestsellers, from technology trends to lifestyle tips.</p>
        </div>
      )}
    </div>
  );
